...
class Video_dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return self.get(record, video_list, segment_indices, directory)
    ...
    def get(self, record, video_list, indices, directory):
        images = list()
        ...
        if self.num_sample > 1:
            ...
            return frame_list, label_list, directory
        else:
            process_data, record_label = self.transform((images, record.label))
            return process_data, record_label, directory
